...
export interface ApiJobPageJobPage extends Schema.SingleType {
  collectionName: 'job_pages';
  info: {
    singularName: 'job-page';
    pluralName: 'job-pages';
  ...
  attributes: {
    title: Attribute.String;
    boxes_description: Attribute.Component<
